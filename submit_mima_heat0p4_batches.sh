#!/bin/bash
#
# Submit the 4x-heating (0.4 K/day) slab experiments in batches of 4 to SLURM
...
declare -a all_experiments=(
    "MiMA_heat0p4_latcent00B_pcent030_noqbo"
    "MiMA_heat0p4_latcent00B_pcent050_noqbo"
    "MiMA_heat0p4_latcent15B_pcent030_noqbo"
    "MiMA_heat0p4_latcent15B_pcent050_noqbo"
    "MiMA_heat0p4_latcent15S_pcent030_noqbo"
    "MiMA_heat0p4_latcent15S_pcent050_noqbo"
    "MiMA_heat0p4_latcent30B_pcent030_noqbo"
    "MiMA_heat0p4_latcent30B_pcent050_noqbo"
    "MiMA_heat0p4_latcent30S_pcent030_noqbo"
    "MiMA_heat0p4_latcent30S_pcent050_noqbo"
    "MiMA_heat0p4_latcent45B_pcent030_noqbo"
    "MiMA_heat0p4_latcent45B_pcent050_noqbo"
    "MiMA_heat0p4_latcent45B_pcent070_noqbo"
    "MiMA_heat0p4_latcent45S_pcent030_noqbo"
    "MiMA_heat0p4_latcent45S_pcent050_noqbo"
    "MiMA_heat0p4_latcent45S_pcent070_noqbo"
    "MiMA_heat0p4_latcent60B_pcent030_noqbo"
    "MiMA_heat0p4_latcent60B_pcent050_noqbo"
    "MiMA_heat0p4_latcent60B_pcent070_noqbo"
    "MiMA_heat0p4_latcent60S_pcent030_noqbo"
    "MiMA_heat0p4_latcent60S_pcent050_noqbo"
    "MiMA_heat0p4_latcent60S_pcent070_noqbo"
    "MiMA_heat0p4_latcent75B_pcent030_noqbo"
    "MiMA_heat0p4_latcent75B_pcent050_noqbo"
    "MiMA_heat0p4_latcent75B_pcent070_noqbo"
    "MiMA_heat0p4_latcent75S_pcent030_noqbo"
    "MiMA_heat0p4_latcent75S_pcent050_noqbo"
    "MiMA_heat0p4_latcent75S_pcent070_noqbo"
    "MiMA_heat0p4_latcent90B_pcent030_noqbo"
    "MiMA_heat0p4_latcent90B_pcent050_noqbo"
    "MiMA_heat0p4_latcent90B_pcent070_noqbo"
    "MiMA_heat0p4_latcent90S_pcent030_noqbo"
    "MiMA_heat0p4_latcent90S_pcent050_noqbo"
    "MiMA_heat0p4_latcent90S_pcent070_noqbo"
    "MiMA_heat0p4_qbo00"
    "MiMA_heat0p4_qbo20"
    "MiMA_hiheat0p4_qbo00"
    "MiMA_hiheat0p4_qbo20"
)
...
for ((batch=0; batch<num_batches; batch++)); do
    batch_num=$((batch + 1))
    batch_script="run_mima_heat0p4_batch${batch_num}.sh"

    # Start batch script
    cat > "$batch_script" << 'EOF_HEADER'
#!/bin/bash
#SBATCH --job-name=mima_heat0p4
#SBATCH --nodes=1
#SBATCH --ntasks=4
...
EOF_HEADER
    ...
    echo "#SBATCH -o mima_heat0p4_batch${batch_num}_%j.txt" >> "$batch_script"
    echo "#SBATCH -e mima_heat0p4_batch${batch_num}_%j.err" >> "$batch_script"
    echo "" >> "$batch_script"
...
for ((batch=0; batch<num_batches; batch++)); do
    batch_num=$((batch + 1))
    echo "  run_mima_heat0p4_batch${batch_num}.sh"
done
echo ""

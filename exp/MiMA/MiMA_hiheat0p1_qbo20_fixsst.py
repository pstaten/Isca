...
exp = Experiment('mima_hiheat0p1_qbo20_fixsst', codebase=cb)

exp.inputfiles = [os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'), os.path.join(GFDL_BASE,'input/sst_ctrl_clim.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'damping_driver_nml': {
        ...
        'do_sin_qbo': True,
        'h_amp':0.1/86400.,
        'p_center': 3000., # 30 hPa instead of default 50 hPa
        'qbo_amp': 20.,
    },

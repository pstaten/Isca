...
exp = Experiment('mima_heat0p1_latcent60s_pcent125_noqbo_symsst', codebase=cb)

exp.inputfiles = [os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'), os.path.join(GFDL_BASE,'input/sst_ctrl_clim_sym.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'damping_driver_nml': {
        ...
        'do_sin_qbo': False,
        'h_amp':0.1/86400.,
        'p_center':12500.0,  # underworld: extratropical lower stratosphere
        'lat_center':-1.047198,
...
if __name__=="__main__":
    ...
    for i in range(2,601): # fixed-SST: short spin-up; 600 months suffices
